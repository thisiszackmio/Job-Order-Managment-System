    ...
    <>
      ...
      <div>
        ...
        <>
          ...
          <div className="border border-solid border-gray-300 rounded-lg p-4">
            <h3 className="text-l font-normal leading-6 text-gray-900">Hello <b>{currentUser.fname}</b> you have a request that needs your approval</h3>
        ...
        <>
          ...
          <div className="border border-solid border-gray-300 rounded-lg p-4">
            <h3 className="text-l font-normal leading-6 text-gray-900">Hello <b>{currentUser.fname}</b> these are the forms that are approved by the Supervisor</h3>
        ...
        <>
          ...
          <div className="border border-solid border-gray-300 rounded-lg p-4">
            <h3 className="text-l font-normal leading-6 text-gray-900">Hello Maam <b>{currentUser.fname}</b> these are the forms that are need to be approved</h3>
