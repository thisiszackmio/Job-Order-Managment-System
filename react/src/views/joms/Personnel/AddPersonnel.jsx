...
export default function AddPersonnel(){
  ...
  const Authorize = codes.includes("GSO") || codes.includes("HACK");
            ...
            <table className="ppa-table w-full mb-10 mt-2">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="px-3 py-2 text-center text-sm font-medium text-gray-600 uppercase">No of Apperance</th>
              ...
              {personnelList.map(staffList => (
                <tr key={staffList.personnel_id}>
                  ...
                  <td className="px-3 py-2 text-center table-font">{staffList.inspection_count}</td>
