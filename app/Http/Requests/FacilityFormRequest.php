...
class FacilityFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'no_table' => 'required_if:table,true|nullable|numeric',
            'chair' => 'required|boolean',
            'no_chair' => 'required_if:chair,true|nullable|numeric',
            'microphone' => 'required|boolean',
            'no_microphone' => 'required_if:microphone,true|nullable|numeric',
