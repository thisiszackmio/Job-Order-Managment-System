...
export default function InspectionForm(){
  ...
  const SubmitPartB = (event, id) => {
    ...
    const formRemarks = `The GSO has filled out Part B of the form and is waiting for the admin manager's approval.`;
  ...
  function handlelAdminApproval(id){
    ...
    axiosClient
    .put(`/admininsprequestapprove/${id}`, {
      logs:logs
    })
    .then(() => {
      setPopupContent("success");
  ...
  const Personnel = inspectionData?.form?.personnel_id == currentUserId?.id;
  const FormClose = inspectionData?.form?.form_status === 0 || inspectionData?.form?.form_status === 4;
        ...
        <div className="p-2">
          ...
          <div className="mt-4 border-b border-gray-300 pb-6">
            ...
            <>
              ...
              {inspectionData?.form?.status === '1004' && GSO && !enablePartA ? (
              <>
                {/* Form */}
          ...
          <div className="mt-4 border-b border-gray-300 pb-6">
            ...
            <>
              ...
              {inspectionData?.form?.status === '1130' && Personnel ? (
              <>
                {/* Form */}
          ...
          <div className="mt-4 pb-6">
            ...
            <>
              ...
              {inspectionData?.form?.status === '1120' && Personnel && !enablePartC ? (
              <>
                {/* Form */}
                        ...
                        <div className="col-span-1">
                          ...
                          <div className="mt-6">
                            <div className="flex">
                              ...
                              <div className="w-64 border-b border-black pl-1 text-pdf">
                                <span>{inspectionData?.form?.property_number}</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="mt-1">
                            <div className="flex">
                              ...
                              <div className="w-64 border-b border-black pl-1 text-pdf">
                                <span>{formatDate(inspectionData?.form?.acquisition_date)}</span>
                              </div> 
                            </div>
                          </div>
                          ...
                          <div className="mt-1">
                            <div className="flex">
                              ...
                              <div className="w-64 border-b border-black pl-1 text-pdf">
                                <span>₱{(inspectionData?.form?.acquisition_cost)}</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="mt-1">
                            <div className="flex">
                              ...
                              <div className="w-64 border-b border-black pl-1 text-pdf">
                                <span>{inspectionData?.form?.brand_model}</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="mt-1">
                            <div className="flex">
                              ...
                              <div className="w-64 border-b border-black pl-1 text-pdf">
                                <span>{inspectionData?.form?.serial_engine_no}</span>
                              </div>
                            </div>
                          </div>
